...
const App = () => {
  ...
  // State to track which product's review form is displayed
  ...
  // Function to toggle the display state for the review form
  ...
  return (
    <div className="outer-cont">
      <h1 style={{ marginTop: "10px", color: "white" }}>Product Review</h1>
            ...
            {displayForms[product._id] && (
              <form
                onSubmit={(e) => {
                  ...
                  // Optionally close the form after submitting
                  toggleReviewForm(product._id);
                }}
              >
                <label>
